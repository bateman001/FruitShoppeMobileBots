exports.config = {
  ...
  //
  specs: ["./run-first-test/specs/first_test.js"],
  // Patterns to exclude.
  exclude: [
  ...
  capabilities: [
    {
      project: "Fruit Shoppe Android Bot Project",
      build: "build 1.0",
      name: "Fruit Shoppe Path 1",
      os: "android",
      os_version: "9.0",
      ...
      "browserstack.networkLogsIncludeHosts": ["fullstory.com"],
